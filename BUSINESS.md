...
```mermaid
graph LR
    subgraph FreeTier ["1. GÓI MIỄN PHÍ CỐT LÕI (Community)"]
        F1["• Tải & chạy trọn đời 0đ<br/>• Local SQLite 100%<br/>• Tự nạp Gemini API Key<br/>• Web + Mobile + Desktop"]
    end
    ...
    ProTier -.->|Mở rộng tổ chức| B2BTier
```
